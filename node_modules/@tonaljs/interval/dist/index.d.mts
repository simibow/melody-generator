import { distance as distance$1 } from '@tonaljs/pitch-distance';
import { IntervalName, interval } from '@tonaljs/pitch-interval';
 ...
 */
declare const semitones: (name: string) => number;
/**
 ...
 */
declare const quality: (name: string) => "dddd" | "ddd" | "dd" | "d" | "m" | "M" | "P" | "A" | "AA" | "AAA" | "AAAA";
/**
 ...
 * Interval.num('P4') // => 4
 */
declare const num: (name: string) => number;
/**
 ...
 */
declare const subtract: (a: IntervalName, b: IntervalName) => IntervalName | undefined;
...
declare const _default: {
    ...
    semitones: (name: string) => number;
    quality: (name: string) => "dddd" | "ddd" | "dd" | "d" | "m" | "M" | "P" | "A" | "AA" | "AAA" | "AAAA";
    ...
    subtract: (a: string, b: string) => string | undefined;
    transposeFifths: typeof transposeFifths;
};

export { add, addTo, _default as default, distance, fromSemitones, get, invert, name, names, num, quality, semitones, simplify, subtract, transposeFifths };
