import { note, NoteLiteral, transpose as transpose$1, IntervalName, NoteName, Note, Pitch } from '@tonaljs/core';
...
export { type NoteComparator, accidentals, ascending, chroma, _default as default, descending, enharmonic, freq, fromFreq, fromFreqSharps, fromMidi, fromMidiSharps, get, midi, name, names, octave, pitchClass, simplify, sortedNames, sortedUniqNames, tr, trBy, trFifths, trFrom, transpose, transposeBy, transposeFifths, transposeFrom, transposeOctaves };
